                                                ...
                                                <div class="table-wrapper">
                                                    <table id="busDataTable" class="data">
														...
														<tr id="head">
															<th>Particulars</th>
															<?php
																	$view = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="one">
															...
															<?php
																	$view1 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="two">
															...
															<?php
																	$view2 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="three">
															...
															<?php
																	$view3 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="four">
															...
															<?php
																	$view4 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="five">
															...
															<?php
																	$view5 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="six">
															...
															<?php
																	$view6 = sqlsrv_query($conn, "SELECT Tb_Recommender.Request_Id,Tb_Recommender.V_id,
																	Tb_Recommender_Meterial.Request_Id,Tb_Recommender_Meterial.V_id
																	FROM Tb_Recommender INNER JOIN Tb_Recommender_Meterial 
																	ON Tb_Recommender.Request_Id = Tb_Recommender_Meterial.Request_Id
															...
															<td>
																<table id="myTable1" class="table table-bordered"
																	...
																	<tbody>
																		...
																		Tb_Recommender_Meterial.Request_Id,Tb_Recommender_Meterial.V_id,Tb_Recommender_Meterial.Quantity,Tb_Recommender_Meterial.Meterial_Name,
																		Tb_Recommender_Meterial.Price,Tb_Recommender_Meterial.Total,Tb_Recommender_Meterial.gst_percentage,Tb_Recommender_Meterial.discount_percentage
																		FROM Tb_Recommender INNER JOIN Tb_Recommender_Meterial 
																		ON Tb_Recommender.Request_Id = Tb_Recommender_Meterial.Request_Id
																		WHERE Tb_Recommender.Request_Id = '$request_id' AND  Tb_Recommender.V_id = '$arr'
																		AND Tb_Recommender_Meterial.V_id = '$arr'
														...
														<tr id="nine">
															...
															<?php
																	$view9 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="ten">
															...
															<?php
																	$view10 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="eleven">
															<th>GST Component</th>
															<?php
																	$view11 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="seven">
															<th>Net Amount</th>
															<?php
																	$view7 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="eight">
															<th>Delivery Time</th>
															<?php
																	$view8 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
																	while ($view_query8 = sqlsrv_fetch_array($view8)) {
															?>
															<td><input type="text" Class="form-control" readonly value="<?php echo $view_query8['Delivery_Time1'] ?>"></td>
															<?php } ?>
														</tr>
														<tr id="twelve">
															<th>Warrenty</th>
															<?php
																	$view12 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<tr id="thirteen">
															<th>Payment Terms</th>
															<?php
																	$view13 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
													...
													<tbody id="eone">
														<tr id="checkbox">
															...
															<?php
																	$view14 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
														...
														<?php 
															...
															<?php
																	$view15 = sqlsrv_query($conn, "SELECT * FROM Tb_Recommender WHERE Request_Id = '$request_id' ");
