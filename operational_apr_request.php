...
if($updated_query['Request_E_Id'] == ''){
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Approved' WHERE Request_OID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    // echo "UPDATE Tb_Approver_EV_Remark set Status = 'Approved' WHERE Request_E_Id = '$Request_E_Id' ";die();
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Approved' WHERE Request_OID = '$Request_E_Id' ");
    ...
    if (!$mail->send()) {
        ...
        ?>
                                                                        <script type="text/javascript">
                                                                            ...
                                                                            window.location = "show_operational_approver.php";
                                                                        </script>
...
Attachment,Persion_In_workflow,Recommender_Remarks,Approver_Remarks,Approver_back_remark,Time_Log,Status,EMP_ID)
 ...
 GETDATE(),'Send Back','$emp_id')";
  ...
  $query1 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Send Back' ,Approver_Send_back = '$Approver_back_remark' WHERE Request_OID = '$Request_E_Id' ");
  $rs = sqlsrv_query($conn, $query);
}else{
  // echo "UPDATE Tb_Payment_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_PID = '$Request_E_Id' ";die();
  $query12 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Send Back' ,Approver_Send_back = '$Approver_back_remark' WHERE Request_OID = '$Request_E_Id' ");
...
if($updated_query['Request_E_Id'] == ''){
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Rejected',Approver_reject = '$Approver_reject' WHERE Request_OID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Rejected',Approver_reject = '$Approver_reject' WHERE Request_OID = '$Request_E_Id' ");
                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item"><a href="show_operational_approver.php">Show Approver Operational Request</a></li>
                                             <li class="breadcrumb-item active">Approver Operational Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
...
<?php 
                                                ...
                                                <center style="padding: 15px 0px 15px 0px;">
                                                    ...
                                                    <button class="btn btn-danger mb-2 me-4 btn-sm" type="submit" name="reject" style="width: 150px;" >
                                                    Reject
                                                    </button>
                                                </center>
