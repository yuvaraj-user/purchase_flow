                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item"><a href="show_informer_rate_request.php">Show Informer Details For Rate&Terms</a></li>
                                             <li class="breadcrumb-item active">View Informer Details For Rate&Terms</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <?php
                                                $update_qry =  sqlsrv_query($conn, "SELECT * FROM Tb_RateTrems_Request WHERE Request_RTID = '$payment_id'");
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                ...
                                                if ($rec_qry['Recommender_Remarks'] == '') {
                                                    ...
                                                    <div class="col-sm-10">
                                                    <?php
                                                        $update_qry12 =  sqlsrv_query($conn, "SELECT * FROM Tb_RateTrems_Request WHERE Request_RTID = '$payment_id'");
                                                        $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                    ?>
