                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="storage-dropdowns form-select add" name="storage_location" id="storage-dropdown">
                                                            </select>
                                                            <select class="storage-dropdowns form-select add1" name="storage_location" id="storage-dropdown1">
                                                            </select>
                                                            <select class="storage-dropdowns form-select add2" name="storage_location" id="storage-dropdown2">
                                                            </select>
                                                        </div>
                                                    </div>
