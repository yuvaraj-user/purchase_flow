...
// echo "UPDATE Tb_Approver_EV_Remark set Approver_Remarks = '$Approver_Remarks' WHERE Request_E_Id = '$payment_id' ";die();
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Approver_EV_Remark set To_Address = '$To_Address',Cc = '$Cc',Persion_In_workflow = '$informer',Approver_Remarks = '$Approver_Remarks' WHERE Request_E_Id = '$payment_id' ");
    ?>
        <script type="text/javascript">
                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Update Approver Rate&Terms Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                ...
                                                <?php
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $updated_query['Approver_back_remark'] ?>" >
                                                    </div>
                                                </div>
                                                <?php
                                                }
