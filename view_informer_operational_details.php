                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item"><a href="show_informer_operational_request.php">Show Informer Details For Operational</a></li>
                                             <li class="breadcrumb-item active">View Informer Details For Operational</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <?php
                                                $update_qry =  sqlsrv_query($conn, "SELECT * FROM Tb_Oprational_Request WHERE Request_OID = '$payment_id'");
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-1" style="width: 110px;"> 
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="validationCustom01" name="Request_pid"
                                                                value="<?php echo $updated_query['Request_OID'] ?>" readonly>
                                                        </div>
                                                    </div>
                                                ...
                                                if ($rec_qry['Recommender_Remarks'] == '') {
                                                    ...
                                                    <div class="col-sm-10">
                                                    <?php
                                                        $update_qry12 =  sqlsrv_query($conn, "SELECT * FROM Tb_Oprational_Request WHERE Request_OID = '$payment_id'");
                                                        $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                    ?>
