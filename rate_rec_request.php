...
if (isset($_POST["save"])) {
    // echo '<pre>';
    // print_r($_POST);die();
    $Request_E_Id = $_POST['Request_rtid'];
    $emp_id = $Employee_Id;
...
if($updated_query['Request_E_Id'] == ''){
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_RateTrems_Request set Status = 'Recommended',Approver_to = '$Requested_to' WHERE Request_RTID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    $query12 = sqlsrv_query($conn, "UPDATE Tb_RateTrems_Request set Status = 'Recommended' WHERE Request_RTID = '$Request_E_Id' ");
...
if($updated_query['Request_E_Id'] == ''){
  ...
  Attachment,Persion_In_workflow,Recommender_Remarks,Recommender_back_remark,Time_Log,Status,EMP_ID)
   ...
   GETDATE(),'Send Back','$emp_id')";
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_RateTrems_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_RTID = '$Request_E_Id' ");
    $rs = sqlsrv_query($conn, $query);
}else{
    // echo "UPDATE Tb_Payment_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_PID = '$Request_E_Id' ";die();
    $query12 = sqlsrv_query($conn, "UPDATE Tb_RateTrems_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_RTID = '$Request_E_Id' ");
...
if($updated_query['Request_E_Id'] == ''){
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_RateTrems_Request set Status = 'Rejected' WHERE Request_RTID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    $query12 = sqlsrv_query($conn, "UPDATE Tb_RateTrems_Request set Status = 'Rejected',Recommender_reject = '$Recommender_reject' WHERE Request_RTID = '$Request_E_Id' ");
                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Recommender Rate & Terms Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
