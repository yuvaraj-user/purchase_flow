...
<html>
                ...
                <table >
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Approver Remark</th>                           
    ...
    $update_qry =  sqlsrv_query($conn, "SELECT * FROM Tb_Approver_EV_Remark WHERE Request_E_Id = '$payment_id'");
    $updated_query = sqlsrv_fetch_array($update_qry);
if($updated_query['Request_E_Id'] == ''){


    $query = "INSERT INTO Tb_Approver_EV_Remark (Request_E_Id,Request_Type,Department,Subject,Request_Date,Requester,Budjected,Approvel_Type,Remark,To_Address,
            Cc,Recommender,Approver,Mail_Subject,Mail_Body,Attachment,Persion_In_workflow,Recommender_Remarks,Approver_Remarks,Time_Log,Status,EMP_ID)
         VALUES('$Request_E_Id','$Request_Type','$Department','$Subject','$Request_Date','$Requester','$Budjected','$Approvel_Type','$Remark','$To_Address','$Cc',
         '$Recommender','$Approver','$Mail_subject','$Mail_Body','$Attachment','$informer','$Recommender_Remarks','$Approver_Remarks',
         GETDATE(),'Approved','$emp_id')";
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Payment_Request set Status = 'Approved' WHERE Request_PID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    // echo "UPDATE Tb_Payment_Request set Status = 'Recommended' WHERE Request_PID = '$Request_E_Id' ";die();
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Payment_Request set Status = 'Approved' WHERE Request_PID = '$Request_E_Id' ");
    $query11 = sqlsrv_query($conn, "UPDATE Tb_Approver_EV_Remark set Status = 'Approved' WHERE Request_E_Id = '$Request_E_Id' ");
}
    ...
    if (!$mail->send()) {
        ...
        ?>
                                                                        <script type="text/javascript">
                                                                            ...
                                                                            window.location = "show_payment_approver.php";
                                                                        </script>
...
if (isset($_POST["send"])) {
    ...
    $Approvel_Type = $_POST['approver_type'];
    $Remark = $_POST['remarks'];
    // $update_qry1 =  sqlsrv_query($conn, "SELECT * FROM Tb_Recommender_EV_Remark WHERE Request_E_ID = '$payment_id'");
    // $updated_query1 = sqlsrv_fetch_array($update_qry1);
    // $PERSION1 =  $updated_query1['To_Address'];

    // $update_qry12 =  sqlsrv_query($conn, "SELECT * FROM Tb_Recommender_EV_Remark WHERE Request_E_ID = '$payment_id'");
    ...
    $Approver_back_remark = $_POST['approver_back_remark'];
...
if($updated_query['Request_E_Id'] == ''){
  ...
  $query = "INSERT INTO Tb_Approver_EV_Remark
...
Attachment,Persion_In_workflow,Recommender_Remarks,Approver_Remarks,Approver_back_remark,Time_Log,Status,EMP_ID)
 VALUES('$Request_E_Id','$Request_Type','$Department','$Subject','$Request_Date',
 '$Requester','$Budjected','$Approvel_Type','$Remark','$To_Address','$Cc',
 '$Recommender','$Approver','$Mail_subject','$Mail_Body','$Attachment','$informer','$Recommender_Remarks','$Approver_Remarks','$Approver_back_remark',
 GETDATE(),'Send Back','$emp_id')";

  $query1 = sqlsrv_query($conn, "UPDATE Tb_Payment_Request set Status = 'Send Back' ,Approver_Send_back = '$Approver_back_remark' WHERE Request_PID = '$Request_E_Id' ");
  $rs = sqlsrv_query($conn, $query);
}else{
//   echo "UPDATE Tb_Approver_EV_Remark set Status = 'Send Back', Approver_Remarks = '$Approver_Remarks',Approver_back_remark = '$Approver_back_remark' WHERE Request_E_Id = '$Request_E_Id' ";die();
  $query12 = sqlsrv_query($conn, "UPDATE Tb_Payment_Request set Status = 'Send Back' ,Approver_Send_back = '$Approver_back_remark' WHERE Request_PID = '$Request_E_Id' ");
  $query11 = sqlsrv_query($conn, "UPDATE Tb_Approver_EV_Remark set Status = 'Send Back', Approver_Remarks = '$Approver_Remarks',Approver_back_remark = '$Approver_back_remark' WHERE Request_E_Id = '$Request_E_Id' ");
}
    ...
    if (!$mail->send()) {
        ...
        ?>
                                                                <script type="text/javascript">
                                                                    alert("Approved Back successsfully");
                                                                    window.location = "show_payment_approver.php";
                                                                </script>
...
if (isset($_POST["reject"])) {
    ...
    $Approver_Remarks = $_POST["approver_remarks"];
    // $informer = $_POST['informer'];
    $Approver_reject = $_POST['Approver_reject'];
...
if($updated_query['Request_E_Id'] == ''){
    $query = "INSERT INTO Tb_Approver_EV_Remark (Request_E_Id,Request_Type,Department,Subject,Request_Date,Requester,Budjected,Approvel_Type,Remark,To_Address,
            Cc,Recommender,Approver,Mail_Subject,Mail_Body,Attachment,Persion_In_workflow,Approver_Remarks,Time_Log,Status,EMP_ID,Approver_reject)
         VALUES('$Request_E_Id','$Request_Type','$Department','$Subject','$Request_Date','$Requester','$Budjected','$Approvel_Type','$Remark','$To_Address','$Cc',
         '$Recommender','$Approver','$Mail_subject','$Mail_Body','$Attachment','$informer','$Approver_Remarks',
         GETDATE(),'Rejected','$emp_id','$Approver_reject')";
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Payment_Request set Status = 'Rejected',Approver_reject = '$Approver_reject' WHERE Request_PID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Payment_Request set Status = 'Rejected',Approver_reject = '$Approver_reject' WHERE Request_PID = '$Request_E_Id' ");
    $query11 = sqlsrv_query($conn, "UPDATE Tb_Approver_EV_Remark set Approver_reject = '$Approver_reject',Status = 'Rejected' WHERE Request_E_Id = '$Request_E_Id' ");
}
    if (!$mail->send()) {
        echo 'Message could not be sent.';
        echo 'Mailer Error: ' . $mail->ErrorInfo;
                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item"><a href="show_payment_approver.php">Show Approver Payment Request</a></li>
                                             <li class="breadcrumb-item active">Approver Payment Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    ?>
                                                    <input type="email" class="form-control" name="to" readonly value='<?php echo $selector_arrq['Office_Email_Address']; ?>' multiple> -->
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <!-- <?php
                                                        ...
                                                        $selectorq = sqlsrv_query($conn, "SELECT  * FROM HR_Master_Table
                                                            ...
                                                            $selector_arrq = sqlsrv_fetch_array($selectorq);
                                                    ?>
                                                    <input type="email" class="form-control"  name="cc" readonly value='<?php echo $selector_arrq12['Office_Email_Address']; ?>,<?php echo $selector_arrq['Office_Email_Address']; ?>'   multiple>  -->
                                                             ...
                                                             <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                                        <div class="modal-dialog modal-dialog-centered">
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <iframe src="file/<?php echo $updated_query['Attchement'] ?>"
                                                ...
                                                $updated_query1 = sqlsrv_fetch_array($update_qry1);
                                            ?>
                                                        <input type="text"  style="font-weight: bold; color: #0000ff;" name="Amount" class="form-control" id="bdt" readonly onkeyup="convertAmount()" value="<?php echo $updated_query1['Amount'] ?>"/> 
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input type="text" style="font-weight: bold; color: #0000ff;" id="container" readonly class="form-control" value="<?php echo $updated_query1['Amount_In_Words'] ?>" name="Amount_In_Words" />
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="recommender_remarks" value="<?php echo $updated_query['Recommender_Remarks'] ?>" readonly >
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="example-datetime-local-input" class="col-sm-2 col-form-label">Approver Remark</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="approver_remarks"  >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="modal fade bs-example-modal-centered" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
															    <textarea class="form-control" name="approver_back_remark" aria-label="With textarea"></textarea>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger waves-effect waves-light btn-sm" data-bs-dismiss="modal" aria-label="Close">Close</button>
                                                ...
                                                <div class="modal fade bs-example-modal-centered1" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
															    <textarea class="form-control" name="Approver_reject" aria-label="With textarea"></textarea>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-danger waves-effect waves-light btn-sm" data-bs-dismiss="modal" aria-label="Close">Close</button>
