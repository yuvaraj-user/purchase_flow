...
// echo "UPDATE Tb_Approver_EV_Remark set Approver_Remarks = '$Approver_Remarks' WHERE Request_E_Id = '$payment_id' ";die();

   sqlsrv_query($conn, "UPDATE Tb_Approver_EV_Remark set To_Address = '$To_Address',Cc = '$Cc',Persion_In_workflow = '$informer',Approver_Remarks = '$Approver_Remarks' WHERE Request_E_Id = '$payment_id' ");
                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Update Approver Payment Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                        ...
                                        <div class="card-body">
                                                    ...
                                                    <div class="col-md-1" style="width: 175px;">
                                                        <div class="mb-3" id="remark">
                                                            <label for="red" class="form-label">Remarks</label>
                                                                <textarea class="form-control" readonly rows="2" name="remarks" id="red"><?php echo $updated_query['Remark'] ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                            ...
                                            ?>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $updated_query['Recommender_Remarks'] ?>" >
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="example-datetime-local-input" class="col-sm-2 col-form-label">Approver Remark</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="approver_remarks"  value="<?php echo $updated_query['Approver_Remarks'] ?>" >
                                                    </div>
                                                </div>
                                                <?php 
                                                if($updated_query['Approver_back_remark'] == ''){
                                                    ?>
                                                ...
                                                <?php
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="" readonly value="<?php echo $updated_query['Approver_back_remark'] ?>" >
                                                    </div>
                                                </div>
                                                <?php
                                                }
