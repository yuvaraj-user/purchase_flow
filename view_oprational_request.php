                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">View Oprational Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="ccf[]" type="text" value="<?php echo $updated_query['Cc'] ?>" readonly >
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" id="" name="mail_subjf" value="<?php echo $updated_query['Mail_Subject'] ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="example-password-input" class="col-sm-2 col-form-label">Mail Body</label>
                                                    <div class="col-sm-10">
                                                    <textarea class="form-control" rows="2" name="remarksf" id="elm2" readonly><?php echo $updated_query['Mail_Body'] ?></textarea>
                                                    </div>
                                                </div>
                                                <?php 
