...
if (isset($_POST["operational_request"])) {
    ...
    // $fil = $_POST["attachementso"];
    if(!isset($_POST['attachementso'])){
        $fil="";
        }else{
          $fil=$_POST['attachementso'];
        }
    ...
    if (isset($_POST['persiono']))
    {
        ...
        $update_qry =  sqlsrv_query($conn, "SELECT * FROM Tb_Oprational_Request WHERE Request_OID = '$oprational_id'");
  ...
  <html>
    ...
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
      ...
      sqlsrv_query($conn, "UPDATE Tb_Oprational_Request SET Request_Type = '$Request_Type',Request_OID = '$Request_OID',Depatment = '$Department',Subject = '$Subject',Request_Date = '$Request_Date',
      ...
      EMP_ID = '$emp_id',Requested_to = '$Requested_to',Time_Log = GETDATE(),Status = 'Requested' WHERE Request_OID ='".$oprational_id."'");
       ...
       <div id="preloader">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-1" style="width: 150px;">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" class="form-control" id="hasta" name="request_dateo" 
                                                    ...
                                                    <div class="col-md-1" style="width: 175px;">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="Requester" readonly name="requestero" value='<?php echo $updated_query['Requester']; ?>'>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="too[]" value="<?php echo $updated_query['To_Address'] ?>" type="text" implode multiple data-role="tagsinput">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="example-search-input" class="col-sm-2 col-form-label">Cc</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="cco[]" type="text" value="<?php echo $updated_query['Cc'] ?>"  implode multiple data-role="tagsinput">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="Recommender" class="col-sm-2 col-form-label">Recommender</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="recommendero" value="<?php echo $updated_query['Recommender'] ?>" id="Recommender">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="Approver" class="col-sm-2 col-form-label">Approver</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text"  name="approvero" value="<?php echo $updated_query['Approver'] ?>" id="Approver">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="subj" class="col-sm-2 col-form-label">Mail Subject</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" name="mail_subjo" value="<?php echo $updated_query['Mail_Subject'] ?>" id="subj">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="example-password-input" class="col-sm-2 col-form-label">Mail Body</label>
                                                    <div class="col-sm-10">
                                                        <textarea id="elm1" name="mail_bodyo"><?php echo $updated_query['Mail_Body'] ?></textarea>
                                                    </div>
                                                </div>
                                                <?php 
                                                    if($updated_query['Attachement'] == ''){
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" name="attachementso" value="<?php echo $updated_query['Attachement'] ?>"
        ...
        <script>
            ...
            $(document).ready(function(){ 
                ...
                $.ajax({
                url: "fetch-type-id.php?id=<?php echo $oprational_id ?>",
                type: "POST",
                data: {
                ...
                <?php
                    $update_qry1 =  sqlsrv_query($conn, "SELECT * FROM Tb_Oprational_Request WHERE Request_OID = '$oprational_id'");
                    $updated_query1 = sqlsrv_fetch_array($update_qry1);
                    $dept = $updated_query1['Depatment'];
                ?>
                var Departmented = '<?php echo $dept ?>'; 
                    $.ajax({
                    url: "fetch-subject-id.php?id=<?php echo $oprational_id ?>",
                    type: "POST",
                    data: {
