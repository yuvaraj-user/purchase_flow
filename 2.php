...
$FB = $_GET['Payment_id'];
$qry = sqlsrv_query($conn, "SELECT  Request_PID FROM Tb_Payment_Request WHERE Request_PID like '%$FB%' order by Request_PID desc ");
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form  method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="col-md-1" style="width: 175px;">
                                                        <div class="mb-3" id="remark">
                                                            <label for="red" class="form-label">Remarks</label>
                                                                <textarea class="form-control" rows="2" name="remarksf" id="red"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" name="ccf[]" type="text" value="<?php echo $selector_arr['Office_Email_Address'] ?>"  implode multiple data-role="tagsinput">
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
