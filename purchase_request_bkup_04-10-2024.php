            ...
            function add_row(action = '')
            {
                ...
                var output = `
                        <tr data-rowno="${row_no}">
                            ...
                            <td>
                                <div class="col-md-12">
                                    <input type="number" min="0" class="form-control required_for_valid" id="quantity${row_no}" style="width: 125px;" name="quantity[]"  placeholder="Enter Quantity" required="" data-id="${row_no}" error-msg='Quantity is mandatory.'>
                                </div>
                                <span class="error_msg text-danger"></span>
                            </td>
                            <td>
           ...
           $(document).on('click', '#add', function () {
            ...
            $(document).on('click','#save',function(){
                  ...
                  if(item_validation_error != '') {
                      ...
                      form.append('Action', 'save_purchase_request');
