...
if (isset($_POST["save"])) {
		...
		$w_budget = $_POST['w_budget'];
		$t_budget = $_POST['t_budget'];
		$a_budget = $_POST['a_budget'];
		$wi_budget = $_POST['wi_budget'];
		$remark = $_POST['remark'];
                             ...
                             <div class="col-sm-6">
                                 <div class="page-title">
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active"> View Review Request</li>
                                         </ol>
                                 </div>
                             </div>
                             <div class="col-sm-6">
                            ...
                            <tbody id="eone">
                                ...
                                <tr class="remark">
                                   ...
                                   $array_dy_Details11 = sqlsrv_fetch_array($array_Details11)
                                        ...
                                        ?>
                                        <td><select class="form-control"  name="w_budget[]" readonly>
                                ...
                                <tr>
                                   ...
                                   $array_dy_Details11 = sqlsrv_fetch_array($array_Details11)
                                        ...
                                        ?>
                                    <td><input type="number" min="0" name="t_budget[]" readonly Value="<?php echo $array_dy_Details11['Total_Budget'] ?>"
                                                    class="form-control">
                                    </td>
                                    <?php
                                    ...
                                    while ($array_dy_Details121 = sqlsrv_fetch_array($array_Details121)) {
                                        ...
                                        ?>
                                        <td><input type="number" min="0" name="t_budget[]" readonly Value="<?php echo $array_dy_Details121['Total_Budget'] ?>"
                                                    class="form-control">
                                        </td>
                                    <?php } ?>
                                ...
                                <tr>
                                   ...
                                   $array_dy_Details11 = sqlsrv_fetch_array($array_Details11)
                                        ...
                                        ?>
                                    <td><input type="number" min="0" name="a_budget[]" readonly Value="<?php echo $array_dy_Details11['Available_Budget'] ?>"
                                                    class="form-control">
                                    </td>
                                    <?php
                                    $array_Details121 = sqlsrv_query($conn, "SELECT Tb_Recommender.Request_id,Tb_Recommender.Vendor_Name,Tb_Finance_verifier.Request_Id,Tb_Finance_verifier.Vendor_Name,
                                    ...
                                    while ($array_dy_Details121 = sqlsrv_fetch_array($array_Details121)) {
                                        ...
                                        ?>
                                        <td><input type="number" min="0" name="a_budget[]"readonly Value="<?php echo $array_dy_Details121['Available_Budget'] ?>"
                                                    class="form-control">
                                        </td>
                                    <?php } ?>
                                ...
                                <tr class="remark">
                                   ...
                                   $array_dy_Details11 = sqlsrv_fetch_array($array_Details11)
                                        ...
                                        ?>
                                        <td><select class="form-control"  name="wi_budget[]" readonly>
