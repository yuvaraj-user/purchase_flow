...
if (isset($_POST["save"])) {
    // echo '<pre>';
    // print_r($_POST);die();
    $Request_E_Id = $_POST['Request_oid'];
    $emp_id = $Employee_Id;
...
if($updated_query['Request_E_Id'] == ''){
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Recommended',Approver_to = '$Requested_to' WHERE Request_OID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Recommended' WHERE Request_OID = '$Request_E_Id' ");
    ...
    if (!$mail->send()) {
        ...
        ?>
                        <script type="text/javascript">
                            ...
                            window.location = "show_operational_recommender.php";
                        </script>
...
if (isset($_POST["send"])) {
    ...
    $Approvel_Type = $_POST['approver_type'];
    $Remark = $_POST['remarks'];
    // $update_qry1 =  sqlsrv_query($conn, "SELECT * FROM Tb_Oprational_Request WHERE Request_OID = '$payment_id'");
...
if($updated_query['Request_E_Id'] == ''){
  ...
  Attachment,Persion_In_workflow,Recommender_Remarks,Recommender_back_remark,Time_Log,Status,EMP_ID)
   ...
   GETDATE(),'Send Back','$emp_id')";
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_oID = '$Request_E_Id' ");
    $rs = sqlsrv_query($conn, $query);
}else{
    // echo "UPDATE Tb_Payment_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_PID = '$Request_E_Id' ";die();
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Send Back' ,Send_Back = '$Recommender_back_remark' WHERE Request_oID = '$Request_E_Id' ");
    $query11 = sqlsrv_query($conn, "UPDATE Tb_Recommender_EV_Remark set Recommender_Remarks = '$Recommender_Remarks',Recommender_back_remark = '$Recommender_back_remark' WHERE Request_E_Id = '$Request_E_Id' ");
}
    if (!$mail->send()) {
        echo 'Message could not be sent.';
        echo 'Mailer Error: ' . $mail->ErrorInfo;
...
if($updated_query['Request_E_Id'] == ''){
    ...
    $query1 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Rejected' WHERE Request_OID = '$Request_E_Id' ");

    $rs = sqlsrv_query($conn, $query);
}else{
    $query12 = sqlsrv_query($conn, "UPDATE Tb_Oprational_Request set Status = 'Rejected',Recommender_reject = '$Recommender_reject' WHERE Request_OID = '$Request_E_Id' ");
                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item"><a href="show_operational_recommender.php">Show Recommender Operational Request</a></li>
                                             <li class="breadcrumb-item active">Recommender Operational Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
