                             ...
                             <div class="col-sm-6">
                                 <div class="page-title">
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Show Informer Details For Rate&Terms</li>
                                         </ol>
                                 </div>
                             </div>
                             <div class="col-sm-6">
                                                        ...
                                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    ...
                                                                    $sql = "SELECT * FROM Tb_RateTrems_Request WHERE Persion_In_Workflow like '%".$_SESSION['EmpID']."%'    ORDER BY Id DESC";
                                                                    $params = array();
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="action-btns">
                                                                                <a href="view_informer_rate_details.php?pay_id=<?php echo $row['Request_RTID'] ?>" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View">
