                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">View Approver Payment Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            ?>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $updated_query['Approver_Remarks'] ?>" >
                                                    </div>
                                                </div>
                                                <?php 
