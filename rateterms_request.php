...
if (isset($_POST["financial_rate"])) {
  ...
  <html>
    ...
    $tmp_name = $_FILES["attachementsr"]["tmp_name"];
      ...
      $statuwss = $selector_arr1d['PO_creator_Release_Codes']; 
        if($statuwss == $Recommender_Code){
            sqlsrv_query($conn, "INSERT INTO Tb_RateTrems_Request
            (Request_Type,Request_RTID,Depatment,Subject,Request_Date,Requester,Budjected,Approvel_Type,To_Address,Cc,Recommender,Approver,
        ...
        VALUES('$Request_RTID','$Request_Type','$Department','$Subject','$Request_Date',
                                                    ...
                                                    <div class="col-md-1" style="width: 110px;"> 
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="validationCustom01" name="Request_rtid"
                                                                value="<?php echo $_ratetermsID ?>" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-1" style="width: 175px;">
                                                        <div class="mb-3" id="remark">
                                                            <label for="red" class="form-label">Remarks<span style="color:red">*</span></label>
                                                                <textarea class="form-control" rows="1" name="remarksr" id="red"></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <?php                                                     
                                                        ...
                                                        if($L1_Mail == $L1_Mail1212){
                                                            ?>
                                                            <input class="form-control" name="ccr[]" type="text" value="<?php echo $selector_arr['Office_Email_Address'] ?>" 
