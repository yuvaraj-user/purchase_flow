                             ...
                             <div class="col-sm-6">
                                 <div class="page-title">
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Show Payment Request</li>
                                         </ol>
                                 </div>
                             </div>
                             <div class="col-sm-6">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $i = 1;
                                                                    $sql = "SELECT * FROM Tb_Payment_Request WHERE EMP_ID = '".$_SESSION['EmpID']."'  ORDER BY Id DESC";
                                                                    $params = array();
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="action-btns">
                                                                                <a href="view_payment_request.php?pay_id=<?php echo $row['Request_PID'] ?>" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View">
                                                                                <i class="mdi mdi-eye"></i>
                                                                            </a>
                                                                                <?php
                                                                                if($row['Status'] == 'Requested'){ 
                                                                                    echo'<a href="update_payment_request.php?pay_id='.$row['Request_PID'] .'" class="action-btn btn-edit bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="datatable1"
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $i = 1;
                                                                    $sql = "SELECT * FROM Tb_Payment_Request WHERE EMP_ID = '".$_SESSION['EmpID']."' AND Status = 'Send Back' ORDER BY Id DESC";
                                                                    $params = array();
                                                                    $options = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
                                                                    $stmt = sqlsrv_prepare($conn, $sql, $params, $options);
                                                                    sqlsrv_execute($stmt);
                                                                ...
                                                                ?>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="action-btns">
                                                                                <a href="update_payment_request.php?pay_id=<?php echo $row['Request_PID'] ?>" class="action-btn btn-view bs-tooltip me-2" data-toggle="tooltip" data-placement="top" title="View">
                                                                                <i class="mdi mdi-pencil"></i>
                                                                            </a>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table id="datatable2"
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $i = 1;
                                                                    $sql = "SELECT * FROM Tb_Payment_Request WHERE EMP_ID = '".$_SESSION['EmpID']."' AND Status = 'Rejected' ORDER BY Id DESC";
                                                                    $params = array();
                                                                    $options = array("Scrollable" => SQLSRV_CURSOR_KEYSET);
                                                                    $stmt = sqlsrv_prepare($conn, $sql, $params, $options);
                                                                    sqlsrv_execute($stmt);
