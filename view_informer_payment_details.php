                                 ...
                                 <div class="page-title">
                                     <!-- <h4>Payment Request</h4> -->
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item"><a href="show_informer_payment_request.php">Show Informer Details For Payment</a></li>
                                             <li class="breadcrumb-item active">View Informer Details For Payment</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <?php
                                                ...
                                                $PERSION2 =  $updated_query['Attachement'];
                                            ?>
                                            <form  method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <?php
                                                        if ($updated_query['Status'] == 'Requested') {
                                                            ?>
                                                            <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query['To_Address']; ?>' multiple>
                                                            <?php
                                                        }else{
                                                            if($updated_query['Status'] == 'Send Back') {
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query['To_Address']; ?>' multiple>
                                                                <?php
                                                            }elseif($updated_query['Status'] == 'Recommended'){
                                                                $update_qry1 =  sqlsrv_query($conn, "SELECT * FROM Tb_Recommender_EV_Remark WHERE Request_E_Id = '$payment_id' AND Status = 'Recommended' ");
                                                                $updated_query1 = sqlsrv_fetch_array($update_qry1);
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query1['To_Address']; ?>' multiple>
                                                                <?php
                                                            }elseif($updated_query['Status'] == 'Approved'){
                                                                $update_qry12 =  sqlsrv_query($conn, "SELECT * FROM Tb_Approver_EV_Remark WHERE Request_E_Id = '$payment_id' AND Status = 'Approved' ");
                                                                $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query12['To_Address']; ?>' multiple>
                                                                <?php
                                                            }elseif($updated_query['Status'] == 'Rejected'){
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query['To_Address']; ?>' multiple>
                                                                <?php
                                                            }
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <?php
                                                        if ($updated_query['Status'] == 'Requested') {
                                                            ?>
                                                            <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query['Cc']; ?>' multiple>
                                                            <?php
                                                        }else{
                                                            if($updated_query['Status'] == 'Send Back') {
                                                                ?>
                                                                ...
                                                                $updated_query1 = sqlsrv_fetch_array($update_qry1);
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query1['Cc']; ?>' multiple>
                                                                <?php
                                                            }elseif($updated_query['Status'] == 'Approved'){
                                                                $update_qry12 =  sqlsrv_query($conn, "SELECT * FROM Tb_Approver_EV_Remark WHERE Request_E_Id = '$payment_id' AND Status = 'Approved' ");
                                                                $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query12['Cc']; ?>' multiple>
                                                                <?php
                                                            }elseif($updated_query['Status'] == 'Rejected'){
                                                                ?>
                                                                <input type="email" class="form-control" name="to" readonly value='<?php echo $updated_query['CC']; ?>' multiple>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                    <textarea class="form-control" rows="2" name="mail_body" id="red" readonly><?php echo $updated_query['Mail_Body'] ?></textarea>
                                                    </div>
                                                </div>
                                                <?php
                                                        if ($updated_query['Status'] == '') {
                                                            
                                                        }else {
                                                            if($updated_query['Attachement'] == ''){

                                                            }elseif ($updated_query['Attachement'] == 'Null') {
                                                ...
                                                <?php 
                                                $rec =  sqlsrv_query($conn, "SELECT * FROM Tb_Recommender_EV_Remark WHERE Request_E_Id = '$payment_id'");
                                                $rec_qry = sqlsrv_fetch_array($rec);
                                                if ($rec_qry['Recommender_Remarks'] == '') {
                                                    ...
                                                    <?php
                                                        ...
                                                        $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                    ?>
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $rec_qry['Recommender_Remarks'] ?>" >
                                                    </div>
                                                </div>
                                                <?php
                                                }
                                                ...
                                                $rec =  sqlsrv_query($conn, "SELECT * FROM Tb_Recommender_EV_Remark WHERE Request_E_Id = '$payment_id'");
                                                $rec_qry = sqlsrv_fetch_array($rec);
                                                if ($rec_qry['Recommender_back_remark'] == '') {
                                                    ...
                                                    <?php
                                                        ...
                                                        $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                    ?>
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $rec_qry['Recommender_back_remark'] ?>" >
                                                    </div>
                                                </div>
                                                <?php
                                                }
                                                ...
                                                <?php 
                                                $apr =  sqlsrv_query($conn, "SELECT * FROM Tb_Approver_EV_Remark WHERE Request_E_Id = '$payment_id'");
                                                $apr_qry = sqlsrv_fetch_array($apr);
                                                if ($apr_qry['Approver_Remarks'] == '') {
                                                    ...
                                                    <?php
                                                        ...
                                                        $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                    ?>
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $apr_qry['Approver_Remarks'] ?>" >
                                                    </div>
                                                </div>
                                                <?php
                                                }
                                                ...
                                                $apr =  sqlsrv_query($conn, "SELECT * FROM Tb_Approver_EV_Remark WHERE Request_E_Id = '$payment_id'");
                                                $apr_qry = sqlsrv_fetch_array($apr);
                                                if ($apr_qry['Approver_back_remark'] == '') {
                                                    
                                                } else {
                                                    ?>
                                                    <div class="row mb-3">
                                                    <label for="example-datetime-local-input" class="col-sm-2 col-form-label">Approver Send Back Remark</label>
                                                    <div class="col-sm-10">
                                                    <?php
                                                        $update_qry12 =  sqlsrv_query($conn, "SELECT * FROM Tb_Payment_Request WHERE Request_PID = '$payment_id'");
                                                        $updated_query12 = sqlsrv_fetch_array($update_qry12);
                                                    ?>
                                                        <input type="text" class="form-control"  name="recommender_remarks" readonly value="<?php echo $apr_qry['Approver_back_remark'] ?>" >
                                                    </div>
                                                </div>
                                                <?php
                                                }
