                             ...
                             <div class="col-sm-6">
                                 <div class="page-title">
                                         <ol class="breadcrumb m-0">
                                             ...
                                             <li class="breadcrumb-item active">Show Exceed Approver Purchase Request</li>
                                         </ol>
                                 </div>
                             </div>
                         </div>
                                                        ...
                                                        <table id="datatable"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            if($row['status'] == 'Waiting_for_approval2'){ 
                                                                    ...
                                                                    <td>
                                                                        <form method="POST">
                                                                                <a href="exceed_request_approve.php?id=<?php echo $row['Request_ID'] ?>"
                                                        ...
                                                        <table id="datatable1"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php
                                                                            if($row['status'] == 'Approver2 Send Back'){ 
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($row = sqlsrv_fetch_array($stmt)) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php
                                                                                if($row['status'] == 'Approver2_Reject'){ 
